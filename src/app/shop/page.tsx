...
import { ProductsSort, queryProducts } from "@/src/wix-api/products";
...
export function generateMetadata({ searchParams: { q } }: PageProps): Metadata {
  return {
    ...
    description: q
      ? `Results for your search query "${q}"`
      : "Browse our shop for various products.",
  };
}
export default async function Page({
  ...
  const title = q ? `Search results for "${q}"` : "Shop";
